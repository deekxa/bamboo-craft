...
export const AboutUs = () => {
  return (
    <>
      <Navbar />
      <section className="px-4 lg:px-4 py-6 bg-gray-100"> {/* Updated background color */}
        <div className="max-w-screen-md mx-auto text-center">
          ...
          <p className="text-base text-gray-700 sm:w-3/4 mx-auto mb-20 leading-relaxed">
            Our greatest motivation to work with bamboo is to help restore Nepal's
            natural beauty and ecological balance. We aim to guide our society towards
            sustainable consumerism—one that allows us to indulge in quality products
            while healing our country's environment through mindful choices. By
            embracing bamboo, we not only support local artisans but also contribute to
            the preservation of Nepal's rich biodiversity and natural resources.
          </p>
        </div>
</section>
    ...
    <div className="max-w-lg text-left lg:w-1/2 lg:flex lg:flex-col lg:justify-end">
      <h1 className="text-3xl font-semibold sm:text-4xl text-white leading-tight tracking-tight">
       ...
       <p className="mt-4 text-base sm:text-lg text-white leading-relaxed font-semibold">
        Discover our wide range of beautifully crafted bamboo items that bring elegance and sustainability into your home. Shop now to find the perfect piece for your space.
      </p>
      ...
      <div className="mt-8 flex gap-4">
        ...
        <a
          href="#"
          className="rounded bg-white px-6 py-3 text-sm font-medium text-rose-600 shadow-md hover:text-rose-700 focus:outline-none focus:ring active:text-rose-500 transition duration-300 ease-in-out transform hover:scale-105"
        >
          Discover More
        </a>
      </div>
  ...
  <div className="w-8/12 text-xl">
    ...
    <span className="flex">
      At Bamboo-craft, we take pride in transforming bamboo from its natural state into stunning, handcrafted furniture and artifacts. Our skilled artisans, with years of experience and a deep passion for their craft, meticulously shape each piece to celebrate the unique imperfections that make bamboo products truly special. We create each item with care, offering both our own designs and custom pieces tailored to your specific needs. Every product we offer reflects our commitment to quality, artistry, and the natural beauty of bamboo.</span> 
</div>
