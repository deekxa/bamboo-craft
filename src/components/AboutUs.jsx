    ...
    <>
      ...
      <section className="px-4 lg:px-4 py-6 bg-gray-100 animate-fadeInUp duration-700">
        <div className="max-w-screen-md mx-auto text-center">
          ...
          <p className="text-base text-gray-700 sm:w-3/4 mx-auto mb-20 leading-relaxed transition-opacity duration-700 ease-in-out opacity-0 animate-fadeInUp animate-delay-300">
      ...
      <article className="relative bg-[url(https://images.pexels.com/photos/6712946/pexels-photo-6712946.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)] bg-cover bg-center bg-no-repeat animate-fadeInSlow">
        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-24 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-lg text-left lg:w-1/2 lg:flex lg:flex-col lg:justify-end transition-all duration-700 ease-in-out">
            <h1 className="text-3xl font-semibold sm:text-4xl text-white leading-tight tracking-tight transition-transform duration-700 ease-in-out transform hover:translate-y-2">
            ...
            <p className="mt-4 text-base sm:text-lg text-white leading-relaxed font-semibold opacity-0 animate-fadeInUp animate-delay-400">
            ...
            <div className="mt-8 flex gap-4">
              <Link
                to="/decor"
                className="rounded bg-rose-600 px-6 py-3 text-sm font-medium text-white shadow-md hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 transition-transform duration-500 ease-in-out transform hover:scale-105"
              >
                Shop Now
              </Link>
            </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between relative w-full h-auto md:h-64 bg-FAF9F6 shadow-2xl rounded-lg p-8 animate-fadeInUp duration-700">
        <div className="w-8/12 text-xl">
          <FaQuoteLeft className="float-left mr-2 text-4xl text-yellow-500 transition-all duration-500 ease-in-out hover:scale-110" />
          <p className="leading-relaxed text-gray-700 transition-opacity duration-700 ease-in-out opacity-0 animate-fadeInUp animate-delay-200">
        ...
        <div className="relative shadow-md font-medium my-5 py-2 px-4 text-white cursor-pointer bg-yellow-600 hover:bg-yellow-500 rounded text-lg text-center w-48 animate-pulse transition-transform duration-500 ease-in-out transform hover:scale-105">
