...
const AboutUs = () => {
  return (
    <>
      <Navbar />
      <section className="px-4 lg:px-4 py-6 bg-gray-100 animate-fadeIn">
        <div className="max-w-screen-md mx-auto text-center">
          <h1 className="text-2xl font-bold text-gray-800 pt-2 pb-4 sm:text-3xl sm:leading-relaxed animate-slideIn">
            About Us
          </h1>
          <p className="text-base text-gray-700 sm:w-3/4 mx-auto mb-20 leading-relaxed animate-fadeIn animate-delay-200">
      ...
      <article className="relative bg-[url(https://images.pexels.com/photos/6712946/pexels-photo-6712946.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)] bg-cover bg-center bg-no-repeat animate-fadeIn">
        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-24 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-lg text-left lg:w-1/2 lg:flex lg:flex-col lg:justify-end animate-slideIn">
            <h1 className="text-3xl font-semibold sm:text-4xl text-white leading-tight tracking-tight animate-fadeUp">
              Elevate Your Space with
              <strong className="block text-rose-400 font-extrabold text-4xl sm:text-5xl">
                Premium Bamboo Products
              </strong>
            </h1>
            <p className="mt-4 text-base sm:text-lg text-white leading-relaxed font-semibold animate-fadeUp animate-delay-200">
            ...
            <div className="mt-8 flex gap-4">
              <Link
                to="/decor"
                className="rounded bg-rose-600 px-6 py-3 text-sm font-medium text-white shadow-md hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 transition duration-300 ease-in-out transform hover:scale-105 animate-bounceIn"
              >
                Shop Now
              </Link>
            </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between relative w-100 h-auto md:h-64 bg-FAF9F6 shadow-2xl rounded-lg p-8 animate-fadeIn">
        <div className="w-8/12 text-xl animate-slideIn">
        ...
        <div className="relative shadow-md font-medium my-5 py-2 px-4 text-white cursor-pointer bg-yellow-600 hover:bg-yellow-500 rounded text-lg text-center w-48 animate-pulse">
