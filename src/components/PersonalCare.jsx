          ...
          <>
            ...
            <button
              ...
              className={`bg-green-500 ${
                openForm ? "hidden" : ""
              } text-white font-bold py-2 px-4 rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 flex items-center transition-transform transform hover:scale-105 duration-300`}
              disabled={isFetching}
            >
              <RefreshCw
        ...
        <div className="pb-10 px-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 animate-fadeIn">
          {filteredArray.map((data, index) => (
            ...
            >
              ...
              <Link to={`/care/${index}`} state={{ product: data }}>
